...
class ArtifactManager {
    ...
    fun getArtifactWithLocationId(locationId: String, onSuccess: (List<Artifact>) -> Unit, onFailure: (error: String) -> Unit){
        artifactApi.getArtifact(locationId).enqueue(object : Callback<List<Artifact>?> {
